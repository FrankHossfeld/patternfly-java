...
@Controller(route = Routes.CONTRIBUTE, selector = Ids.ROOT_CONTAINER, component = ContributeElement.class, componentInterface = Contribute.Component.class)
public class ContributeController
        extends AbstractComponentController<ShowcaseContext, Contribute.Component, HTMLElement>
